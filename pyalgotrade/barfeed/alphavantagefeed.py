...
class Feed(csvfeed.BarFeed):
    """A :class:`pyalgotrade.barfeed.csvfeed.BarFeed` that loads bars from CSV files downloaded from Alpha Vantage.
    ...
    .. note::
        Alpha Vantage csv files lack timezone information.
